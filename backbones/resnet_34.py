...
class ResNetSE34(nn.Module):
    def __init__(self, 
        ...
        print('Embedding size is %d, encoder %s.'%(num_embedding, encoder_type))
        ...
        self.fc_embeding = nn.Linear(out_dim, num_embedding)
        self.fc_class = nn.Linear(num_embedding, num_classes)
